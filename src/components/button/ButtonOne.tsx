...
const ButtonOne: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center gap-2 text-white bg-primary border border-transparent rounded-xl shadow-md focus:ring-2 focus:ring-primary focus:ring-offset-2 curso outline-none ${classes} ${pending || disabled ? 'opacity-50 cursor-not-allowed' : 'hover:cursor-pointer hover:border-primary hover:text-primary hover:bg-transparent'}`}
